...
2.  **Operating Status Calculation**: Rust derives the device status (Default, Geofence, Home WiFi) by combining `notifications` (Geofence bits) and `spare_c5` (ESZ bits).
