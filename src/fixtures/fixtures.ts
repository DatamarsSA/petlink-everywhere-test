...
const baseFixtures = {
  KIPPY: {
    ...
    coupon: commonCoupon,
    prepaidOrder: {
      orderSource: "KIPPYEU" as const,
      restCountry: "eu" as const,
      externalOrderName: "#PREPAID_TEST",
      status: "paid",
      total: "62.07",
      currency: "EUR",
      paymentMethod: "adyen-cc",
      ip: "159.26.106.57",
      address: {
        first_name: "Mario",
        last_name: "Rossi",
  ...
  PETLINK: {
    ...
    coupon: commonCoupon,
    prepaidOrder: {
      orderSource: "PIDUS" as const,
      restCountry: "us" as const,
      externalOrderName: "#PREPAID_TEST",
      status: "paid",
      total: "62.07",
      currency: "USD",
